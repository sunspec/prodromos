...
def pso(func, lb, ub, x0=None, ieqcons=[], f_ieqcons=None, args=(), kwargs={}, 
    ...
    ========
    x0 : np.array
        one starting particle position to use as initial condition (added by C. W. Hansen)
    ieqcons : list
    ...
    License
    =======
    Original code taken from https://github.com/tisimst/pyswarm with stated
    BSD 3-Clause License (license file not provided with code.)

    Code modified by C. W. Hansen of Sandia National Laboratories for the
    ProDromos project.

    Subject to originator's copyright, code changes copyright (c) 2019,
