...
# pyComtrade: A python Class for read  IEEE
...
class ComtradeRecord:
    ...
    def ReadCFG(self):
        ...
        #print('Number of A and D channels:  ',self.A,self.D)
        ...
        # Read line frequency:
        self.lf = float(self.filehandler.readline().rstrip())

        # Read sampling rates:
        self.nrates = int(len(self.filehandler.readline())/2) # nrates.
        ...
        self.timemul = float(self.filehandler.readline().rstrip())
    ...
    def getAnalogChannelData(self,ChNumber):
        ...
        #Raw_Data = numpy.empty((N,1))
        ch_index = self.An.index(ChNumber)
        #f=open("C:/Users/pnhe001/DOcuments/Projects/GA Tech SE/pyComtrade-0.2.0/examples/RawData.txt", 'w')
        ...
        #print(ChNumber)    
        #print(self.a[ch_index], self.b[ch_index])
        values = (values * self.a[ch_index])+self.b[ch_index] # a factor
